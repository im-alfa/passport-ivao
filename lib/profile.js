...
exports.parse = function(json) {
  ...
  // ID
  if (json.given_name) { profile.firstName = json.given_name; }
  if (json.family_name) { profile.lastName = json.family_name; }
  ...
  if (json.rating) {
    ...
    if (json.rating.isAtc) { profile.atcRating = json.rating.atcRating.id; } else { profile.atcRating = 0; }
  }
